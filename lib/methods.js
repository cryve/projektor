...
import { memberSchema, jobSchema, contactSchema, linkSchema, teamCommSchema } from "/lib/collections/schemas.js";
...
export const deleteEditableArrayItem = new ValidatedMethod({
  ...
  run({collectionName, docId, arrayField, item}) {
    ...
    if((doc.owner && doc.owner.userId || doc._id) != this.userId) {
