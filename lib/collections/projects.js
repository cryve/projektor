...
Meteor.methods({
  "projects.insert"(projectDraft) {
    Projects.insert(projectDraft);
  },
  "projects.setMedia"(projectId, newMedia) {
    Projects.update(projectId, {$set: {media: newMedia}});
  },
  "projects.setCoverImg"(projectId, newCoverImg) {
    Projects.update(projectId, {$set: {coverImg: newCoverImg}});
  },
  "projects.updateTeam" (projectId, newTeam) {
    Projects.update(projectId, {$set: {team: newTeam}});
  },
});
