...
if(Meteor.isServer) {
  Meteor.publish("projectsAll", function projectsPublication() {
    return Projects.find();
  });
  Meteor.publish("singleProject", function singleProjectPublication(projectId) {
    return Projects.find(projectId);
  });
  Meteor.publish("userProjects", function userProjectsPublication(userId) {
    console.log("subscribe to user projects", userId)
    const userProjects = Projects.find({team: {$elemMatch: {"userId": userId}}});
    console.log("subscribe to user projects", userProjects);
    return userProjects;
  });
}
